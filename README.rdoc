...
* coma uses Maildir as backing store; this is more reliable and widely
  supported.
* coma has built-in MIME support.
...
tmail and json.  Only tested with Ruby 1.8.

coma currently needs metamail(1) to display mail and file(1) and
mhbuild(1) to send MIME mail.
...
== tkma
  ...
  XXX TODO, rough port of exmh to be expected.
